...
const pro11 = pid => {
     return new Promise((resolve, reject) => {
          console.log('pro11 진입 setTimeout 전');
          setTimeout(() => {
               if (pid == 'jamsuham') {
          ...
          console.log('pro11 끝 부분 이제부터 4초 카운트');
     });
}
const pro12 = ppw => {
     return new Promise((resolve, reject) => {
          console.log('pro12 진입 setTimeout 전');
          setTimeout(() => {
               if (ppw == '1111') {
          ...
          console.log('pro12 끝 부분 이제부터 4초 카운트');
     });
}
const id12 = 'jamsuham';
const pw12 = '1111';
pro11(id12).
then(result => {
     console.log('pro11 4초 카운트 끝');
     console.log('result11', result);
     return pro12(pw12);
}).then(result => {
     console.log('pro12 4초 카운트 끝');
